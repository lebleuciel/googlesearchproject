...
func (fq *FileQuery) Clone() *FileQuery {
	...
	return &FileQuery{
		...
		withFiletype: fq.withFiletype.Clone(),
...
func (fq *FileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*File, error) {
	...
	if query := fq.withFiletype; query != nil {
		if err := fq.loadFiletype(ctx, query, nodes, nil,
			func(n *File, e *Filetype) { n.Edges.Filetype = e }); err != nil {
			return nil, err
		}
	}
...
func (fq *FileQuery) loadFiletype(ctx context.Context, query *FiletypeQuery, nodes []*File, init func(*File), assign func(*File, *Filetype)) error {
...
func (fq *FileQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := fq.ctx.Fields; len(fields) > 0 {
		...
		if fq.withFiletype != nil {
			_spec.Node.AddColumnOnce(file.FieldType)
		}
	}
